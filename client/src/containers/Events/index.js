...
class Event extends Component {
  renderTeamByEvent = (field) => {
    return <List.Item>{this.getTeamItem()}</List.Item>;
  };
  renderSelectTeam = (field) => {
    // console.log(field.input);
    return <select {...field.input}>{this.getTeamList()}</select>;
  };
  ...
  getTeamItem = () => {
    ...
    return (
      this.props.eventList?.teams?.length !== 0 &&
      this.props.eventList?.teams?.map((team) => {
        // console.log("teams")
        // console.log(name)
        return (
    ...
    return (
      <div>
        <Segment textAlign="left">
          <Grid>
            <Grid.Row>
              <Grid.Column width={10}>
                <Header
                  as="h3"
                  style={{ color: "#ca50a1", textTransform: "uppercase" }}
                >
                  Event Name:
                  <Header.Content
                    style={{
              ...
              <Grid.Column width={5}>
                <Form onSubmit={handleSubmit(this.onSubmit)}>
                  ...
                  <Grid.Row>
                    ...
                    >
                      <Header as="h5">
                        Select a team to add to this event:
                      </Header>
          ...
          <div
            style={{ height: "250px", overflowX: "scroll", paddingTop: "30px" }}
          >
          ...
          <Segment inverted>
            <Form inverted>
              <Form.Group widths="equal">
                <Form.Input fluid label="Event Name" placeholder="Event name" />
                <Form.Input fluid label="Event DIstance" placeholder="Event DIstance" />
                <Form.Input start='1' end='7' fluid label="Start Date" placeholder="Start Date" />
                <Form.Input start='1' end='7' fluid label="End Date" placeholder="End date" />
              </Form.Group>
